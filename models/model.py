...
class EmbeddingNet(nn.Module):
    ...
    def __init__(self, embedding_dim=128):
        ...
        # Replace the original classifier with a new linear layer for embedding generation.
    ...
    def forward(self, x):
        ...
        # L2-normalize the output embedding vector for consistent distance metrics.
...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, embedding1, embedding2, label):
        ...
        # Loss for negative pairs (distance should be > margin)
...
def main():
    ...
    # 1. Verify the Embedding Network
    logging.info("\n--- Verifying EmbeddingNet ---")
    embedding_net = EmbeddingNet(embedding_dim=128).to(device)
    # print(embedding_net) # Uncomment to inspect the model structure
    ...
    # 2. Verify the Contrastive Loss function
